...
- **Automatisations livreur** : `ACCEPTE <code>` (prendre) · `RECU` (colis récupéré → `InTransit`) · `LIVRE` (livré → `Delivered`) — avec code optionnel (`RECU A1B2C3D4`). Confirmations avec détails de livraison.
